 ...
 *  Print to tri_<len>_<height>_Ti<init-t>_Tf<final-t>_tau<tau>.tsv <- Triangular lattice for
 * Simulated Annealing Print to tri_<len>_<height>_Gi<init-g>_Gf<final-g>_tau<tau>.tsv <- Triangular
